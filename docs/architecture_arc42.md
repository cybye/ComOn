...
* **ADR 22: ComOn 2-Screen Messenger Architektur (Option A Crown Header & Direct Chat Threads):**
  ...
  4. *Hauptmenü-Verschlankung*: Das Hauptmenü (`MainMenu`) wurde auf 3 Kernfunktionen fokussiert (SOS Notruf, Einstellungen, Beenden). Die Chat-Auswahl sowie das Senden von Nachrichten oder Standortdaten entfallen im Hauptmenü, da sie direkt auf dem Hauptbildschirm und im Chat-Thread erreichbar sind.
